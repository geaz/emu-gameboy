...
namespace GGB::Enums
{
    ...
    enum INTERRUPT_FLAG
    {
        INPUT = 16,    // (Prio 5) Bit 4: Transition from High to Low of Pin number P10-P13
        SERIAL = 8,   // (Prio 4) Bit 3: Serial I/O transfer complete
        TIMER = 4,    // (Prio 3) Bit 2: Timer Overflow              
        LCD = 2,      // (Prio 2) Bit 1: LCDC 
        V_BLANK = 1   // (Prio 1) Bit 0: V-Blank
    };

    enum LCD_CONTROL_FLAG
    {
        ENABLE = 128,               // Bit 7 - LCD Display Enable             (0=Off, 1=On)
        ...
        BG_ENABLE = 1                   // Bit 0 - BG Display                     (0=Off, 1=On)
    };

    enum LCD_STATUS_FLAG
    {
        C_INTERRUPT_ENABLED = 64,       // Bit 6 - LYC=LY Coincidence Interrupt (1=Enable) (Read/Write)
